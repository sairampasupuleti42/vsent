...
class PHPMailer {
  ...
  /**
   * Components the complete compiled MIME message body.
   * @var string
   * @access protected
   */
  protected $MIMEBody       = '';
  ...
  /**
   * Components the complete compiled MIME message headers.
   * @var string
   * @access protected
   */
  ...
  /**
   * Components the complete sent MIME message (Body and Headers)
   * @var string
   * @access protected
  */
